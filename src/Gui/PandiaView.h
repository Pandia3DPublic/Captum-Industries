...
public:
	...
	bool PandiaView::setCameraPos( Eigen::Matrix4d extrinsic);
	void PandiaView::setRealCPos(Eigen::Matrix4d extrinsic);
	...
	open3d::visualization::GLHelper::GLMatrix4f GetMVPMatrix() const { return MVP_matrix_; }
	open3d::visualization::GLHelper::GLMatrix4f GetProjectionMatrix() const {
		return projection_matrix_;
	}
	open3d::visualization::GLHelper::GLMatrix4f GetViewMatrix() const { return view_matrix_; }
	open3d::visualization::GLHelper::GLMatrix4f GetModelMatrix() const { return model_matrix_; }
	open3d::visualization::GLHelper::GLVector3f GetEye() const { return eye_.cast<GLfloat>(); }
	open3d::visualization::GLHelper::GLVector3f GetLookat() const { return lookat_.cast<GLfloat>(); }
	open3d::visualization::GLHelper::GLVector3f GetUp() const { return up_.cast<GLfloat>(); }
	open3d::visualization::GLHelper::GLVector3f GetFront() const { return front_.cast<GLfloat>(); }
	open3d::visualization::GLHelper::GLVector3f GetRight() const { return right_.cast<GLfloat>(); }
	...
	void setBoundingBox(std::vector<Eigen::Vector3f>& points);
...
public:
	...
	Eigen::Vector3d eye_; //cam position
	Eigen::Vector3d lookat_; //center where the cam looks
	Eigen::Vector3d up_;
	Eigen::Vector3d front_; //vector from center to camera
	...
	open3d::visualization::GLHelper::GLMatrix4f projection_matrix_;
	open3d::visualization::GLHelper::GLMatrix4f view_matrix_;
	open3d::visualization::GLHelper::GLMatrix4f model_matrix_;
	open3d::visualization::GLHelper::GLMatrix4f MVP_matrix_;
